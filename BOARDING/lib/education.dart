...
Padding education_card(String degree, String institute, String year,
    String specialization, String gpa, String status) {
  return Padding(
        ...
        body: ListView(
          ...
          children: <Widget>[
            for (Map<String, dynamic> item in widget.list_education)
              education_card(item['degree'], item['institute'], item['year'],
                  item['specialization'], item['gpa'], item['status'])
          ],
        ),
      ),
    );
