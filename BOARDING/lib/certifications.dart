...
Padding certificate(String title,String organization, String certificate_type, String year, String company){
  return Padding(
          ...
          body: ListView(
            ...
            children: <Widget>[
               for (Map<String, dynamic> item in widget.list_certifications)
                    certificate(item['title'], item['organization'], item['certificate_type'], item['year'],item['organization'].toString().toLowerCase())
