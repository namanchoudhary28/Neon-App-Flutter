...
Container skill_card(String name) {
  return Container(
      ...
      child: Text(name,
          ...
          style: TextStyle(fontSize: 15.0, color: PdfColor(1, 1, 1))));
}
...
reportView(
    context, List list_about, List list_communications, List skills) async {
  final Document pdf = Document();

  final PdfImage profile_image = await pdfImageFromImageProvider(
      pdf: pdf.document,
      image: const material.AssetImage('assets/images/man.png'));
  ...
  for (int i = 0; i < list_communications.length; i++) {
    ...
    social_icon = await pdfImageFromImageProvider(
        pdf: pdf.document,
        image: material.AssetImage('assets/social_icons/$medium.png'));
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            Text(list_about[0]['name'].toString().toUpperCase(),
                                style: TextStyle(
                                  fontSize: 20.0,
                                )),
                            Text(list_about[0]['location'],
                                style: TextStyle(
                                  fontSize: 20.0,
                                )),
                            Container(
